...
from reana_db.models import ResourceType, User, UserWorkflow, Workflow

from reana_server import __version__
from reana_server.decorators import signin_required
from reana_server.utils import serialize_utc_datetime
...
@signin_required(access_denied_code="access_not_granted")
def get_you(user):

...
from reana_server.groups.indigo_iam import IndigoIamGroupBackend
from reana_server.groups.keycloak import KeycloakGroupBackend

_BACKEND_TYPES = {
    "keycloak": KeycloakGroupBackend,
    "cern": CernGroupBackend,
    "eosc": EoscGroupBackend,
    "indigo_iam": IndigoIamGroupBackend,
}
    ...
    if _registry is None:
        ...
        for backend_config in REANA_GROUP_BACKENDS:
            ...
            if not backend_class:
                logging.error("Unknown group backend type %r, ignoring.", backend_type)
                continue

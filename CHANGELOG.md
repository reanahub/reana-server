...
## [0.9.5](https://github.com/reanahub/reana-server/compare/0.9.4...0.9.5) (2026-09-22)


### ⚠ BREAKING CHANGES

* **auth:** Upgrade the REANA cluster, UI and clients together for OIDC; clients using legacy REANA access tokens cannot authenticate. Configure REANA_AUTH_ISSUER, the required token audiences and role, and REANA_SECRET_KEY, with Redis and web-client credentials for browser login. Link existing accounts with reana-admin link-user-identity or explicitly enable trusted email linking, recreate legacy GitLab webhooks with delegated secrets and sign in again after upgrading. Replace Invenio launch commands with flask run or reana_server.wsgi:application.
* **validation:** POST /api/workflows now accepts a multipart specification bundle instead of a client-serialized reana_specification JSON body. Replacement restarts now upload a raw reana.yaml to the dedicated /restart endpoint. New clients require a server that advertises the workflow-specification-bundles-v1 capability.
...
* **auth:** replace Invenio with OIDC and JWT authentication ([#789](https://github.com/reanahub/reana-server/issues/789)) ([f81334f](https://github.com/reanahub/reana-server/commit/f81334fa0b4f034599d55e8add48c832a4f6b76c))
...
* **validation:** validate workflow specifications on server ([#794](https://github.com/reanahub/reana-server/issues/794)) ([a85f7a7](https://github.com/reanahub/reana-server/commit/a85f7a7e739d7e86da2dff5c6da1f82020ccc177))
...
* **config:** stop sending deprecated X-XSS-Protection header ([#814](https://github.com/reanahub/reana-server/issues/814)) ([c88f3f3](https://github.com/reanahub/reana-server/commit/c88f3f304dbd5fab058d3e9abcc99a28c9c49b42))
...
* **factory:** initialise workspace umask ([#796](https://github.com/reanahub/reana-server/issues/796)) ([ff461d8](https://github.com/reanahub/reana-server/commit/ff461d8c8514073c85f56142aed84dc968771974))
...
* **rest:** allow same-origin embedding of PDF previews ([#814](https://github.com/reanahub/reana-server/issues/814)) ([774f57a](https://github.com/reanahub/reana-server/commit/774f57ab23006dc2c9876ac141527e999ad158a2))
...
* **rest:** hide HTCondor file-transfer directories ([#810](https://github.com/reanahub/reana-server/issues/810)) ([a06651b](https://github.com/reanahub/reana-server/commit/a06651b073ecf0f2662e4d421850f7c7e8bb34cc))
...
* **workspace:** preserve shared workspace permissions ([#802](https://github.com/reanahub/reana-server/issues/802)) ([a54f53f](https://github.com/reanahub/reana-server/commit/a54f53f0a190ce20d59ec59ab62bd2d69f850150)), closes [#801](https://github.com/reanahub/reana-server/issues/801)
...
* **release-please:** upgrade action to v5 ([#806](https://github.com/reanahub/reana-server/issues/806)) ([478606f](https://github.com/reanahub/reana-server/commit/478606fd9580fac98acdcf2b1fc774ed2111a34b))
...
* **openapi:** declare PDF previews in download API ([#814](https://github.com/reanahub/reana-server/issues/814)) ([07e264a](https://github.com/reanahub/reana-server/commit/07e264a6f3d7ab26dc838ec610fc38b620553e20))

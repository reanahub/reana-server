...
def base_app(tmp_shared_volume_path):
    ...
    config_mapping = {
        ...
        "REANA_AUTH": {
            ...
            "userinfo_url": f"{TEST_ISSUER}/userinfo",
        },
    }
